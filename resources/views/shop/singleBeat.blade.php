        ...
        <div class="product-details">
                    ...
                    <div class="swiper-container" data-effect="fade">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="product-details-img-wrap swiper-slide">
                                <img src="{{ asset($beat->cover_image) }}" alt="product" data-swiper-parallax="-10">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    <div class="product-details-info-price">MWK {{ $beat->amount }}</div>
                    <h3 class="product-details-info-title">{{ $beat->title }}</h3>
                    <p class="product-details-info-text">
                        Producer: {{ $beat->producer }} 
                        
                    </p>
                    <p class="product-details-info-text">
                        Genre: {{ $beat->category->name }} 
                    ...
                    <p class="product-details-info-text">
                        ...
                        Downloads: {{ $beat->downloads_count }}
                    </p>

                    <form action="{{ route('cart.add') }}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ $beat->uuid }}">
                        <input type="hidden" name="model" value="App\Beat">
                        <div class="quantity">
