        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('My Audios') }}
                    <a href="{{ route('myAudioCreate') }}" class="btn btn-success btn-round btn-sm float-right">Upload New</a>
                          ...
                          <tbody>
                              ...
                              @empty
                                  <div class="alert alert-warming text-capitalize text-xl-center">
                                      You have not uploaded any Mp3 song. Click the about green button to upload
                                  </div>
                              @endforelse
                          </tr>
