...
<head>
    ...
    <title>Tk Gate Motors and Electric Fencing</title>
</head>
<body>
    <main class="main-content text-center">
        <div class="container-fluid h-100vh bg-gray ">
  
          <h1 class="display-3 text-muted mb-7">You dont have that permission</h1>
          <p class="lead"><strong>Sorry! </strong> Seems you're not Authorized for that action.</p>
          <br>
